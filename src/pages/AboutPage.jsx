...
const AboutMe = () => {
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
      <h1>About Me</h1>
      <p>
        Hello! My name is Brandon Bybee and I am a trainin to become a web developer. I am currently a student at the University of Kansas studying computer science. 
